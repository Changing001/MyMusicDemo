...
public class View_Game_dontstepwhite extends View implements View.OnClickListener{
    ...
    private ArrayList<RectsPostion_game_dontstepwhite> mArraylist_Rect;
    private RectsPostion_game_dontstepwhite rectPostion;
    private boolean IfYouLose=false;
    private boolean IfStart=false;

    public View_Game_dontstepwhite(Context context) {
        super(context);
    }
    public View_Game_dontstepwhite(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void init() {
        ...
        rectPostion=new RectsPostion_game_dontstepwhite();
